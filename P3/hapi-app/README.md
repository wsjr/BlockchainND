...
This project is built using [HapiJS](https://hapijs.com) that serves as Web API on top of our private blockchain to submit and retrieve blockchain data.
...
npm init
```
- Install Hapi. Used as our web API framework. Make sure to provide **"--save"** flag to save dependency to our package.json

```
npm install hapi@17.x.x --save
```
...
* [HapiJS](https://hapijs.com/) - The web framework for NodeJS.
